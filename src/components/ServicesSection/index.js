...
const ServicesSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Take control of your registration process with our expert site testing service. On request, we'll meticulously review your setup, identify potential issues, and provide you with the knowledge and tools to make updates proactively.",
